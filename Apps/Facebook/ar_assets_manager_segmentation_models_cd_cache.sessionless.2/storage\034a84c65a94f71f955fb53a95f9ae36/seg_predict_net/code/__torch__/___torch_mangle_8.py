class SegmentationWrapper(Module):
  ...
  def get_metadata(self: __torch__.___torch_mangle_8.SegmentationWrapper) -> Tuple[int, int, str, str, int]:
    self_metadata = (192, 192, "segmentation", "1001", 1)
    return self_metadata
  def forward(self: __torch__.___torch_mangle_8.SegmentationWrapper,
    input: Tensor) -> Tensor:
